...
public class FoodActivity1 extends Activity {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                back.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent in = new Intent(FoodActivity1.this,MainActivity1.class);
                        startActivity(in);
                ...
                bt1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent in = new Intent(FoodActivity1.this,FoodResultActivity.class);
                        in.putExtra("which","1,1");
                        startActivity(in);
                        overridePendingTransition(0, 0);
                        finish();
                    }
